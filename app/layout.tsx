...
export const metadata: Metadata = {
  ...
  title: {
    default: "كارستايل | رش مطفي ورش مطاطي ورش وكالة للسيارات بالرياض - محمد الرباحي",
    template: "%s | كارستايل",
  },

  description:
    "كارستايل بالرياض متخصصون في رش السيارات، السمكرة، رش مطفي ، رش مطاطي ، النانو سيراميك، العازل الحراري، رش الجنوط وتجهيز السيارات بأحدث التقنيات.",
  ...
  openGraph: {
    title: "كارستايل | رش مطفي ورش مطاطي للسيارات بالرياض",
